<template>
  <Page shouldUserBeAuthenticated>
    <div id="ranking-page">
      <div id="top-ranks">
        <RankingItem v-for="(topuser, index) in rankingTopUsers" :key="index" :index="index" :user="topuser" />
      </div>
      <div id="other-ranks">
        <RankingItem v-for="(user, index) in ranking" :key="index" :index="index + 3" :user="user" />
      </div>
    </div>
  </Page>
</template>
